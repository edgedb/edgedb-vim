...
syntax match edgeqlDunders /\m\c\<\(__source__\|__std__\|__subject__\|__type__\)\>/
syntax match edgeqlKeywords /\m\c\<\(::\|\.\|\.<\|\.>\)\@<!\(\(named \+only\)\|\(as \+text\)\|abort\|alter\|analyze\|and\|anyarray\|anytuple\|begin\|case\|check\|commit\|configure\|create\|deallocate\|declare\|delete\|describe\|detached\|discard\|distinct\|do\|drop\|else\|empty\|end\|execute\|exists\|explain\|extending\|fetch\|filter\|for\|get\|global\|grant\|group\|if\|ilike\|import\|in\|insert\|introspect\|is\|like\|limit\|listen\|load\|lock\|match\|module\|move\|not\|notify\|offset\|optional\|or\|order\|over\|partition\|policy\|populate\|prepare\|raise\|refresh\|reindex\|release\|reset\|revoke\|rollback\|select\|set\|start\|typeof\|union\|update\|variadic\|when\|window\|with\|abstract\|after\|alias\|all\|allow\|annotation\|as\|asc\|assignment\|before\|by\|cardinality\|cast\|config\|conflict\|constraint\|current\|database\|ddl\|default\|deferrable\|deferred\|delegated\|desc\|emit\|explicit\|final\|first\|from\|function\|implicit\|index\|infix\|inheritable\|into\|isolation\|last\|link\|migration\|multi\|object\|of\|oids\|on\|only\|onto\|operator\|overloaded\|owned\|postfix\|prefix\|property\|proposed\|pseudo\|read\|reject\|rename\|repeatable\|required\|restrict\|role\|roles\|savepoint\|scalar\|schema\|sdl\|serializable\|session\|single\|source\|superuser\|system\|target\|ternary\|then\|to\|transaction\|type\|unless\|using\|verbose\|view\|write\)\>/
syntax match edgeqlModules /\m\c\<\(::\|\.\|\.<\|\.>\)\@<!\(cal\|cfg\|math\|schema\|std\|stdgraphql\|sys\)\>/
syntax match edgeqlTypes /\m\c\<\(\.\|\.<\|\.>\)\@<!\(BaseObject\|Object\|anyenum\|anyfloat\|anyint\|anynumeric\|anyreal\|anyscalar\|anytype\|array\|bigint\|bool\|bytes\|datetime\|decimal\|duration\|enum\|float32\|float64\|int16\|int32\|int64\|json\|local_date\|local_datetime\|local_time\|sequence\|str\|tuple\|uuid\)\>/
